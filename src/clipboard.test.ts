...
describe('copyTextToClipboard', () => {
  it('uses navigator.clipboard when the QDN view permits it', async () => {
    ...
    await expect(copyTextToClipboard('qdn://APP/Bookmarks/Bookmarks?view=developers', dependencies)).resolves.toBe(true);
    expect(writeText).toHaveBeenCalledWith('qdn://APP/Bookmarks/Bookmarks?view=developers');
  });
